        ...
        $(document).ready(function(){
            var table = $('#dt-users').DataTable({
                        ...
                        "columns": [
                            ...
                            {name: 'tagsub', orderable: true, searchable: true},
                ...
                <div class="panel-body">
                    <div class="dataTable_wrapper">
                        ...
                        <table id="dt-users" class="table table-hover table-condensed">
                            ...
                            <tbody>
                            @foreach ($tagSubs as $item)
                                <tr>
                                    <td class="text-center"></td>
                                    <td>{{ $item->tag_sub_name }}</td>
                                    <td>{{ \App\Models\TagMain::getTagMainName($item->tag_main_id) }}</td>
                                    <td class="text-center">
                                        <a href="{{ URL::to('backend/subTag_edit') }}/{{ $item->id }}"
