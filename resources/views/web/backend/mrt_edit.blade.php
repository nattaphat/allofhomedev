            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="col-md-12">
                        ...
                        {!! Form::open(['route' => ['backend_mrt_update'],
                        'id'=> 'my-form', 'data-ajax' => 'true',
                        'class' => 'form-horizontal']) !!}

                        {!! Form::hidden('id', $mrt->id) !!}

                        <div class="form-group">
                            {!! Form::label('route_id', 'สาย', [
                            'class' => 'col-md-2 control-label']) !!}
                            <div class="col-md-8">
                                {!! Form::select('route_id', $mrtRoute, $mrt->route_id,[
                                'class' => 'form-control'
                                ]) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            {!! Form::label('mrt_name', 'สถานี', [
                            'class' => 'col-md-2 control-label']) !!}
                            <div class="col-md-8">
                                {!! Form::text('mrt_name', $mrt->mrt_name,[
                                'class' => 'form-control'
                                ]) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::select('status', array(
                                ...
                                $mrt->status == true? 'true' : 'false', ['class' => 'form-control']) !!}
                            </div>
                        </div>
