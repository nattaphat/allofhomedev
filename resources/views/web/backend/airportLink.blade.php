        ...
        $(document).ready(function(){
            var table = $('#dt-users').DataTable({
                        ...
                        "columns": [
                            ...
                            {name: 'station', orderable: true, searchable: true},
                ...
                <div class="panel-body">
                    <div class="dataTable_wrapper">
                        ...
                        <table id="dt-users" class="table table-hover table-condensed">
                            ...
                            <tbody>
                            @foreach ($airportLink as $item)
                                <tr>
                                    <td class="text-center"></td>
                                    <td>{{ $item->apl_name }}</td>
                                    <td>{{ $item->status == true? "ใช้งาน" : "ยังไม่เปิดให้บริการ" }}</td>
                                    <td class="text-center">
                                        <a href="{{ URL::to('backend/airportLink_edit') }}/{{ $item->id }}"
