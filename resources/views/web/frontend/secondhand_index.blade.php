...
@section('content')
    ...
    <div class="boxreview">
        <h2>ที่อยู่อาศัยมือสอง</h2>
        <h2 class="lineColor"></h2>
        <div class="clear"></div>
        <span class="lineDescription">ที่อยู่อาศัยมือสอง</span>
                    ...
                    @foreach($cat as $item)
                        <li>
                            ...
                            <div class="left">
                                ...
                                <a href="{{ url("secondhand/")."/".$item->id }}"><h3>{{ $item->title }}</h3></a>
