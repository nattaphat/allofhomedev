            ...
            <div class="row">
                <div class="col-md-6">
                    <a href="{{ URL::to("townhome/create") }}"><i class="fa fa-plus-square"></i>
                        เพิ่มประกาศหมวดหมู่โครงการทาวน์โฮมใหม่</a>
                </div>
                <div class="col-md-6">
                    <div class="input-group">
                        <input type="text" class="form-control"
                               placeholder="ค้นหาประกาศหมวดหมู่ทาวน์โฮมใหม่">
                    <span class="input-group-btn">
                        <button class="btn btn-default" type="button">ค้นหา</button>
                    </span>
                    </div>
                                                ...
                                                <div class="post-author">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <ul class="list-inline links" style="text-align: right">
                                                            ...
                                                            <li>
                                                                <a href="{{ URL::route("townhome_view", ["id" => $item->id]) }}" class="btn btn-default btn-xs"><i class="fa fa-comment"></i> 76 Comments</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
