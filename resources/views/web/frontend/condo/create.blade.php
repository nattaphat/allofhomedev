                        ...
                        <div class="panel-body" style="margin: 0px 5px 15px 15px;">
                            <div class="block features">
                                <h2 class="title-divider" >
                                    <span style="color: #55a79a;">เพิ่มประกาศหมวดหมู่คอนโดใหม่</span>
                                </h2>
                            </div>
                            <div class="row">
                                {!! Form::open(array('url'=>'condo/create', 'method' => 'POST', 'files' => 'true',
                                ...
                                <div class="form-group @if ($errors->has('project_type')) {{ "has-error" }} @endif" style="padding-top:30px;">
                                    ...
                                    <div class="col-md-6">
                                        <label class="checkbox-inline">
                                            <input type="checkbox" name="project_type[]" value="4"
                                            <?php
