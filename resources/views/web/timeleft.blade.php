...
<div class="container" id="about">
    ...
    <div class="timeline timeline-left">
      ...
      <div class="timeline-item right animated fadeIn de-02">
        ...
        <p class="timeline-item-description">Abbas hendrerit importunus sudo veniam. Genitus illum importunus nisl tamen virtus.</p>
      </div>
      ...
      <div class="timeline-item highlight animated fadeIn de-02">
        ...
        <p class="timeline-item-description">Abluo brevitas loquor molior nimis odio pagus quadrum valetudo. Os praesent ulciscor utrum ymo.</p>
      </div>
      ...
      <div class="timeline-item right animated fadeIn de-02">
        ...
        <p class="timeline-item-description">Aliquam sino ulciscor valde. Abbas brevitas facilisis ille imputo lucidus pagus pecus sino utinam.</p>
      </div>
