...
<head>
    ...
    <!-- Select2 -->
    <link type="text/css" type="text/css" href="{{ asset('js/lib/select2-dist/dist/css/select2.min.css') }}" rel="stylesheet">
...
@section('body')
    ...
    <!--select2 -->
    <script src={{ asset('js/lib/select2-dist/dist/js/select2.min.js') }}></script>
