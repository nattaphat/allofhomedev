            ...
            <li class="slide" data-transition="fade" data-slotamount="5" data-masterspeed="1800">
                ...
                <!-- SLIDE 1 Content-->
                    <div class="slide-content">
                        ...
                        <h2 
                            class="tp-caption customin randomrotateout" 
                            data-x="700" data-y="120" 
                            data-speed="400" 
                            data-start="1200" 
                            data-customin="
                                            x:0;
                        ...
                        <a 
                            href="#" 
                            class="tp-caption customin randomrotateout btn btn-lg btn-primary" 
                            data-x="700" 
                            data-y="220" 
                            data-speed="400" 
                            data-start="1800" 
                            ...
                            data-easing="Back.easeOut" 
                            data-endspeed="400" 
                            data-endeasing="Back.easeIn">Buy Now</a> 
                    </div>
            </li>
            <!-- SLIDE 2 -->
            <li data-transition="curtain-1" data-slotamount="4" data-masterspeed="500" >
                <img 
                    src="{{ asset('img/patterns/lightpaperfibers.png')}}" 
                    alt="slidebg1" 
                    data-bgfit="normal" 
                ...
                <div class="slide-content">
                    ...
                    <h2 
                        class="tp-caption largeblackbg sfb randomrotateout" 
                        data-x="center" 
                        data-y="30" 
                        data-speed="1500" 
                        data-start="2300" 
