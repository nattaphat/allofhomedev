...
<div class="boxVdoReview">
    ...
    @else
        ...
        <div id="collapsible-panels" class="data-project">
                    ...
                    @if($catHomePic[$i] != null && count($catHomePic[$i]) > 0)
                        ...
                        @foreach($pics as $pic)
                            <div>
                                ...
                                @endif
                                <div>
                                    <img data-src="{{ $pic->filepath }}" alt="{{ $pic->filename }}" />
                                </div>
                                <div>
            ...
            <a href="#" class="head-data active">รีวิวตัวบ้าน</a>
            <div class="detail">
                @for($i=20; $i<=31; $i++)
                    @if($catHomePic[$i] != null && count($catHomePic[$i]) > 0)
                        <?php
            ...
            <a href="#" class="head-data active">รีวิวสเปก</a>
            <div class="detail">
                @for($i=32; $i<=43; $i++)
                    @if($catHomePic[$i] != null && count($catHomePic[$i]) > 0)
                        <?php
...
<div class="boxFinan">
    ...
    <div class="form-finan">
        ...
        <div class="right">
            ...
            <ul>
                <li><a href="#"><img data-src="{{ asset('images/logo/tmb.jpg') }}" alt="" /></a></li>
                <li><a href="#"><img data-src="{{ asset('images/logo/ktb.jpg') }}" alt="" /></a></li>
                <li><a href="#"><img data-src="{{ asset('images/logo/krungsri.png') }}" alt="" /></a></li>
                <li><a href="#"><img data-src="{{ asset('images/logo/kasikorn.jpg') }}" alt="" /></a></li>
...
@include('layouts._partials.brand_home_part')