...
class CreatVipCurrentTable extends Migration {
	...
	public function up()
	{
        Schema::create('vip_current', function(Blueprint $table)
        {
            $table->increments('id');
//            $table->primary('id');
            ...
            $table->integer('vip_feature')->nullable(false);
